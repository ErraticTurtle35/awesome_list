...
class _$Article extends Article {
  ...
  factory _$Article([void updates(ArticleBuilder b)]) =>
      (ArticleBuilder()..update(updates)).build();
  ...
  _$Article._(
      ...
      : super._() {
    if (id == null) {
      throw BuiltValueNullFieldError('Article', 'id');
    }
    if (type == null) {
      throw BuiltValueNullFieldError('Article', 'type');
    }
    if (by == null) {
      throw BuiltValueNullFieldError('Article', 'by');
    }
    if (time == null) {
      throw BuiltValueNullFieldError('Article', 'time');
    }
    if (kids == null) {
      throw BuiltValueNullFieldError('Article', 'kids');
    }
    if (parts == null) {
      throw BuiltValueNullFieldError('Article', 'parts');
    }
  }
...
class ArticleBuilder implements Builder<Article, ArticleBuilder> {
  ...
  ListBuilder<int> get kids => _$this._kids ??= ListBuilder<int>();
  ...
  ListBuilder<int> get parts => _$this._parts ??= ListBuilder<int>();
